...
try:
    ...
    link = "https://www.facebook.com/Zheil0ng"
    ...
    AUTOGENFBA.main()  # Assumes 'main' exists; will raise an error if it doesn't.

except ImportError as e:
    print("❌ Import error:", e)

except AttributeError:
    print("⚠️ 'main' function not found. Check available attributes:", dir(AUTOGENFBA))
